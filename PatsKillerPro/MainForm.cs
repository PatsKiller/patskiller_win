    ...
    public partial class MainForm : Form
    {
        ...
        private void BuildUI()
        {
            ...
            _lblUser = new Label
            {
                ...
                AutoEllipsis = true,
                MaximumSize = new Size(Dpi(320), 0)
            };
...
private void ApplyAuthHeader()
{
    ...
    if (IsLoggedIn)
    {
        ...
        _lblTokensPromo.Visible = tbs.PromoTokens > 0;

        // Promo expiry (separate line; hide if not provided)
        var promoExp = tbs.PromoExpiresAt;
        if (promoExp.HasValue && tbs.PromoTokens > 0)
        {
